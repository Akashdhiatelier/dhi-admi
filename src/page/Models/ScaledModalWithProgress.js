...
const ProgressFallback = (props) => (
	<Mesh name="progressbarMesh" rotation={props.progressRotation} position={props.center}>
		<Box
			key="progress"
			name="boxProgress"
		...
		>
			<StandardMaterial name="progressbar" diffuseColor={props.progressBarColor} specularColor={Color3.Green()} />
		</Box>
		<Box
			key="back"
			name="boxBack"
